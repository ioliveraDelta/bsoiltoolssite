...
<html lang="pt-br">
  <head>
    ...
    $textos=$pdo->prepare("SELECT * FROM textos WHERE ID = 8");
    $textos->execute();
    $textos = $textos->fetch();

    $paginaURL       = "./diretoria.php";
    ...
    <section id="conteudo" class="py-8 py-md-5border-bottom">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3">
            <a href="./doc/certificado-api-q1.pdf" target="_blank">
              <img src="./doc/certificado-api-q1.png" alt="" class="img-fluid">
            </a>
          </div>

          <div class="col-md-3">
            <a href="./doc/certificado-5ct-2131.pdf" target="_blank">
              <img src="./doc/certificado-5ct-2131.png" alt="" class="img-fluid">
            </a>
          </div>

          <div class="col-md-3">
            <a href="./doc/certificado-11d1-0166.pdf" target="_blank">
              <img src="./doc/certificado-11d1-0166.png" alt="" class="img-fluid">
            </a>
          </div>

          <div class="col-md-3">
            <a href="./doc/certificado-iso9001.pdf" target="_blank">
              <img src="./doc/certificado-iso9001.png" alt="" class="img-fluid">
            </a>
          </div>
