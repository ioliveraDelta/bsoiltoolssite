<?php
  ...
  require_once('fullBanner-banco.php');
      ...
      <div class="container">
        <div class="row bg-white rounded">
            ...
            <div class="col-12 col-md-9">
              ...
              <nav class="mb-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-scroll">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">
                    <a class="text-gray-700" href="../index.php" target="_blank">
                      <i class="fas fa-eye" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Visualizar página publicada" aria-label="visualizar"></i> Visualizar na Home
                    </a>
                  </li>
                </ol>
              </nav>
              ...
              <div class="p-3 mb-0 form-group text-capitalize">
                <label class="text-muted" for="subTitulo"><i class="fas fa-angle-right"></i> subTitulo</label>
                <input type="text" class="form-control form-control-flush" name="subTitulo" id="subTitulo" value="<?= $campo_subTitulo ?>" placeholder="SubTitulo">
              </div>
              ...
              <div class="p-3 mb-0 form-group text-capitalize">
                <label class="text-muted" for="link"><i class="fas fa-angle-right"></i> Link</label>
                <input type="text" class="form-control form-control-flush" name="link" id="link" value="<?= $campo_link ?>" placeholder="https://">
              </div>
