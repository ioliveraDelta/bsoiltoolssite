              ...
              <nav class="mb-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-scroll">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">
                    <a class="text-gray-700" href="texto.php?t=<?=  $campo_id ?>" target="_blank">
                      <i class="fas fa-eye" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Visualizar página publicada" aria-label="visualizar"></i> visualizar página
                    </a>
                  </li>
                </ol>
              </nav>
